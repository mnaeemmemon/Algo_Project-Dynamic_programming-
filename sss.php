...
<?php
    ...
    { 
        ...
        function printans($X,$Y,$dp, $index,$m, $n)
        {
            $i = $m;
            $j = $n; 
            $str="";
        ...
        // $X2=substr($X,0,$s-1);
        // $Y2=substr($Y,0,$s2-1);
        $ans=superSeq($X, $Y, strlen($X), strlen($Y));
        $_SESSION["scsval"]=$ans;
        $ansname=$_SESSION["scs"]; 
    ...
    <div id="wrapper">
        <section class="top-discount-area d-md-flex align-items-center">
            ...
            <div class="single-discount-area" style="background-color: green; color: black">
                <h2 style="color:black; font-size: 22px" >Shortest Common Subsequence</h2>
            </div>
            <div class="single-discount-area" style="background-color: black">
                <h5>----------------------------------------------------------------</h5>
            </div>
        ...
        <div style="background-color: black">
            <form method="post" class="inputs" style="margin-left: 0%">
            <div>
                <?php
                $val=$_SESSION["scsval"];
                $ans=$_SESSION["scs"];
                ...
                echo "<label class='seq_head_2' style='margin-top: 10px; margin-left: 30px;' >The Length Of SCS Is : $val</label><br>";
        ...
        <div style="background-color: black;">
        <iframe width="60%" height="600px" style="margin-left: auto; margin-right: auto; display: block; margin-top: 30px; margin-bottom: 20px" src="https://www.youtube.com/embed/823Grn4_dCQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>

    ...
    <div id="wrapper">
        <section class="top-discount-area d-md-flex align-items-center">
            ...
            <div class="single-discount-area" style="background-color: green; color: black">
                <h2 style="color:black; font-size: 22px" >Longest Increasing Subsequence</h2>
            </div>
            <div class="single-discount-area" style="background-color: black">
                <h5>----------------------------------------------------------------</h5>
            </div>
        ...
        <div style="background-color: black">
            ...
            <div>
                ...
                $val2=implode(',',$val);
                $val3=sizeof($val);
                echo "<label class='seq_head_2' style='margin-left: 30px; margin-top: 10px'>The Length Of LIS Is : $val3</label><br>";
                echo "<label class='seq_head_2' style='margin-left: 30px;'>The LIS Is : $val2</label><br>";
                $_SESSION["lis"]=" "; 
                ?>
            </div>
            </form>
        ...
        <div style="background-color: black;">
        <iframe width="60%" height="600px" style="margin-left: auto; margin-right: auto; display: block; margin-top: 30px; margin-bottom: 20px" src="https://www.youtube.com/embed/Ns4LCeeOFS4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
